...
export const sendContactForm = async (formData) => {
  ...
  try {
    const templateParams = {
      ...
      to_email: 'Bookings@barracabanas.com', // Your business email
    };
    ...
    return {
      success: false,
      message: 'Failed to send message. Please contact us directly at Bookings@barracabanas.com or call +27 66 205 7229.'
    };
  }
};
